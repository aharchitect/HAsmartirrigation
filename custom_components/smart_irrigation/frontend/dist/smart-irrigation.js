      ...
      <ha-dialog open .heading=${!0}>
        ...
        <div class="wrapper">
          <div class="dialog-help">
            ${Vo("irrigation_start_triggers.dialog.help",this.hass.language)}
            <code>smart_irrigation_start_irrigation_all_zones</code>
          </div>
          <div class="form-group">
            <label class="form-label"
              >${Vo("irrigation_start_triggers.fields.name.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="text"
          ...
          <div class="form-group">
            <ha-select
              .label=${Vo("irrigation_start_triggers.fields.type.name",this.hass.language)}
              .value=${this._trigger.type}
              @selected=${this._typeChanged}
            >
              <ha-dropdown-item value=${Te}>
                ${Vo("irrigation_start_triggers.trigger_types.sunrise",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${"sunset"}>
                ${Vo("irrigation_start_triggers.trigger_types.sunset",this.hass.language)}
              </ha-dropdown-item>
              <ha-dropdown-item value=${Me}>
                ${Vo("irrigation_start_triggers.trigger_types.solar_azimuth",this.hass.language)}
              </ha-dropdown-item>
            </ha-select>
          </div>
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Vo("irrigation_start_triggers.fields.enabled.name",this.hass.language)}
            >
              <ha-switch
          ...
          <div class="form-group">
            <label class="form-label"
              >${Vo("irrigation_start_triggers.fields.offset_minutes.name",this.hass.language)}</label
            >
            <input
              class="form-input"
              type="number"
          ...
          <div class="form-group">
            <ha-formfield
              .label=${Vo("irrigation_start_triggers.fields.account_for_duration.name",this.hass.language)}
            >
              <ha-switch
          ...
          ${this._trigger.type===Me?q`
                <div class="form-group">
                  <label class="form-label"
                    >${Vo("irrigation_start_triggers.fields.azimuth_angle.name",this.hass.language)}</label
                  >
                  <input
                    class="form-input"
                    type="number"
        ...
        <ha-dialog-footer slot="footer">
          ...
          ${t?"":F`
                ...
                >
                  ${Vo("irrigation_start_triggers.dialog.delete",this.hass.language)}
                </ha-button>
              `}
          <ha-button
            slot="primaryAction"
...
`;let rl=class extends(La(ce)){constructor(){super(...arguments),this.isLoading=!0,this.isSaving=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.debouncedSave=(()=>{let e=null;return a=>{e&&clearTimeout(e),e=window.setTimeout((()=>{this.saveData(a),e=null}),500)}})()}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass){this._hasLoadedOnce||(this.isLoading=!0,this._scheduleUpdate());try{this.config=await Oa(this.hass),this.data=(e=this.config,a=["calctime","autocalcenabled","autoupdateenabled","autoupdateschedule","autoupdatefirsttime","autoupdateinterval","autoclearenabled","cleardatatime","continuousupdates","sensor_debounce","manual_coordinates_enabled","manual_latitude","manual_longitude","manual_elevation","days_between_irrigation"],e?Object.entries(e).filter((([e])=>a.includes(e))).reduce(((e,[a,t])=>Object.assign(e,{[a]:t})),{}):{})}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}var e,a}}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}render(){var e,a,t;if(!this.hass||!this.config||!this.data)return q`<div class="loading-indicator">
        ...
        ${Vo("common.loading-messages.general",this.hass.language)}
          ...
          ${Vo("panels.general.cards.automatic-duration-calculation.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.general.cards.automatic-duration-calculation.labels.auto-calc-enabled",this.hass.language)}
            </div>
            <ha-switch
        ...
        header="${Vo("panels.general.cards.automatic-duration-calculation.header",this.hass.language)}"
      >
        ${e}</ha-card
      >`;let a=q` <div class="card-content">
          ${Vo("panels.general.cards.automatic-update.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.general.cards.automatic-update.labels.auto-update-enabled",this.hass.language)}
            </div>
            <ha-switch
          ...
          <div class="card-content">
            <div class="setting-row">
              <div class="setting-label">
                ${Vo("panels.general.cards.automatic-update.labels.auto-update-interval",this.hass.language)}
              </div>
              <div class="combo-field">
                ...
                <div class="select-wrap">
                  ...
                  >
                    ...
                    >
                      ${Vo("panels.general.cards.automatic-update.options.minutes",this.hass.language)}
                    </option>
                    <option
                      value="${Oe}"
                      ?selected=${this.data.autoupdateschedule===Oe}
                    >
                      ${Vo("panels.general.cards.automatic-update.options.hours",this.hass.language)}
                    </option>
                    <option
                      value="${Ne}"
                      ?selected=${this.data.autoupdateschedule===Ne}
                    >
                      ${Vo("panels.general.cards.automatic-update.options.days",this.hass.language)}
                    </option>
                  </select>
      ...
      this.hass.language)}">${a}</ha-card>`;let i=q` <div class="card-content">
          ${Vo("panels.general.cards.automatic-clear.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.general.cards.automatic-clear.labels.automatic-clear-enabled",this.hass.language)}
            </div>
            <ha-switch
        ...
        header="${Vo("panels.general.cards.automatic-clear.header",this.hass.language)}"
        >${i}</ha-card
      >`;let n=q`<div class="card-content">
          ${Vo("panels.general.cards.continuousupdates.description",this.hass.language)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.general.cards.continuousupdates.labels.continuousupdates",this.hass.language)}
            </div>
            <ha-switch
        ...
        header="${Vo("panels.general.cards.continuousupdates.header",this.hass.language)}"
        >${n}</ha-card
      > `;const r=this.renderTriggersCard(),s=this.renderWeatherSkipCard(),o=this.renderCoordinateCard(),l=this.renderDaysBetweenIrrigationCard(),d=this.renderObservedWateringCard();return q`<ha-card
          header="${Vo("panels.general.title",this.hass.language)}"
        >
          <div class="card-content">
      ...
      >
        <div class="card-content">
          ${Vo("irrigation_start_triggers.description",this.hass.language)}
        </div>

        <div class="card-content trigger-usage">
          ${Vo("irrigation_start_triggers.usage_before",this.hass.language)}
          <code>smart_irrigation_start_irrigation_all_zones</code>${Vo("irrigation_start_triggers.usage_after",this.hass.language)}
        </div>

        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("irrigation_start_triggers.active_label",this.hass.language)}
            </div>
            <select
              class="field"
            ...
            >
              ...
              >
                ${Vo("irrigation_start_triggers.active_default",this.hass.language)}
              </option>
              ${e.map((e=>q`
                  <option
                    value="${e.name}"
          ...
          <div class="trigger-active-hint">
            ${Vo("irrigation_start_triggers.active_hint",this.hass.language)}
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div class="add-trigger-section">
            ${this._actionBtn(Qo,Vo("irrigation_start_triggers.add_trigger",this.hass.language),(()=>this._addTrigger()))}
          </div>
        </div>
      </ha-card>
    `}renderTriggerItem(e,a){if(!this.hass)return q``;const t=Vo(`irrigation_start_triggers.trigger_types.${e.type}`,this.hass.language);let i="";if(e.type===Te&&0===e.offset_minutes)i=Vo("irrigation_start_triggers.offset_auto",this.hass.language);else{const a=Math.abs(e.offset_minutes),t=Math.floor(a/60),n=a%60,r=e.offset_minutes<0?Vo("common.labels.before",this.hass.language):Vo("common.labels.after",this.hass.language);i=t>0?`${t}h ${n}m ${r}`:`${n}m ${r}`}let n="";return e.type===Me&&void 0!==e.azimuth_angle&&(n=` (${e.azimuth_angle}°)`),q`
      <div class="trigger-item ${e.enabled?"enabled":"disabled"}">
        <div class="trigger-main">
          ...
          <div class="trigger-status">
            ${e.enabled?Vo("common.labels.enabled",this.hass.language):Vo("common.labels.disabled",this.hass.language)}
          </div>
        </div>
    ...
    `}_addTrigger(){this._showTriggerDialog({createTrigger:!0})}_editTrigger(e){var a,t;const i=null===(t=null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||void 0===t?void 0:t[e];i&&this._showTriggerDialog({trigger:i,triggerIndex:e})}_deleteTrigger(e){var a,t;if(!(null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||!this.hass)return;const i=(null===(t=this.config.irrigation_start_triggers[e])||void 0===t?void 0:t.name)||"Unknown";if(confirm(Vo("irrigation_start_triggers.confirm_delete",this.hass.language).replace("{name}",i))){const a=[...this.config.irrigation_start_triggers];a.splice(e,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ee]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}}async _showTriggerDialog(e){if(!this.hass)return;const a=document.createElement("smart-irrigation-trigger-dialog");a.hass=this.hass,a.addEventListener("trigger-save",(e=>{this._handleTriggerSave(e.detail)})),a.addEventListener("trigger-delete",(e=>{this._handleTriggerDelete(e.detail)})),document.body.appendChild(a),await a.showDialog(e),a.addEventListener("closed",(e=>{const t=e.target;t&&"ha-dialog"===t.tagName.toLowerCase()&&document.body.removeChild(a)}))}_handleTriggerSave(e){if(!this.config)return;const a=this.config.irrigation_start_triggers?[...this.config.irrigation_start_triggers]:[];e.isNew?a.push(e.trigger):void 0!==e.index&&(a[e.index]=e.trigger),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:a}),this.saveData({[Ee]:a}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}_handleTriggerDelete(e){var a;if(!(null===(a=this.config)||void 0===a?void 0:a.irrigation_start_triggers)||void 0===e.index)return;const t=[...this.config.irrigation_start_triggers];t.splice(e.index,1),this.config=Object.assign(Object.assign({},this.config),{irrigation_start_triggers:t}),this.saveData({[Ee]:t}).catch((e=>{console.error("Error saving triggers:",e),this._fetchData().catch((()=>{}))}))}renderWeatherSkipCard(){return this.config&&this.data&&this.hass?q`
      <ha-card header="${Vo("weather_skip.title",this.hass.language)}">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("weather_skip.title",this.hass.language)}
            </div>
            <ha-switch
          ...
          ${this.config.skip_irrigation_on_precipitation?this._numRow(Vo("weather_skip.threshold_label",this.hass.language),Ta(this.config,Se),this.config.precipitation_threshold_mm,(e=>this.handleConfigChange({precipitation_threshold_mm:parseFloat(e)})),.1):""}
        </div>
      </ha-card>
    `:q``}renderObservedWateringCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.language;return q`
      <ha-card header="${Vo("observed_watering.title",e)}">
        <div class="card-content">
          ${Vo("observed_watering.description",e)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("observed_watering.enabled_label",e)}
            </div>
            <ha-switch
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("observed_watering.direct_control_label",e)}
            </div>
            <ha-switch
          ...
          ${this.config.direct_valve_control_enabled?q`
                <div class="card-content">
                  ${Vo("observed_watering.direct_control_description",e)}
                </div>
                <div class="setting-row">
                  <div class="setting-label">
                    ${Vo("observed_watering.sequencing_label",e)}
                  </div>
                  <select
                    class="field"
                  ...
                  >
                    ...
                    >
                      ${Vo("observed_watering.sequencing.sequential",e)}
                    </option>
                    <option
                      value="parallel"
                      ?selected=${"parallel"===this.config.zone_sequencing}
                    >
                      ${Vo("observed_watering.sequencing.parallel",e)}
                    </option>
                  </select>
                </div>
              `:""}
    ...
    `}renderCoordinateCard(){if(!this.config||!this.data||!this.hass)return q``;const e=this.hass.config,a=(null==e?void 0:e.latitude)||0,t=(null==e?void 0:e.longitude)||0,i=(null==e?void 0:e.elevation)||0;return q`
      <ha-card
        header="${Vo("coordinate_config.title",this.hass.language)}"
      >
        <div class="card-content">
        ...
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("coordinate_config.manual_enabled",this.hass.language)}
            </div>
            <ha-switch
            ...
            ${this.data.manual_coordinates_enabled?q`
                    ${this._numRow(Vo("coordinate_config.latitude",this.hass.language),"",this.data.manual_latitude||a,(e=>this.handleConfigChange({manual_latitude:parseFloat(e)})),.1)}
                    ${this._numRow(Vo("coordinate_config.longitude",this.hass.language),"",this.data.manual_longitude||t,(e=>this.handleConfigChange({manual_longitude:parseFloat(e)})),.1)}
                    ${this._numRow(Vo("coordinate_config.elevation",this.hass.language),"",this.data.manual_elevation||i,(e=>this.handleConfigChange({manual_elevation:parseFloat(e)})),1)}
                  `:q`
                    <div
                      class="zoneline"
                      style="color: var(--secondary-text-color); font-style: italic;"
                    >
                      ${Vo("coordinate_config.current_ha_coords",this.hass.language)}:<br />
                      ${Vo("coordinate_config.latitude",this.hass.language)}:
                      ${a}<br />
                      ${Vo("coordinate_config.longitude",this.hass.language)}:
                      ${t}<br />
                      ${Vo("coordinate_config.elevation",this.hass.language)}:
                      ${i}m
                    </div>
                  `}
                </div>
    ...
    `}renderDaysBetweenIrrigationCard(){return this.config&&this.data&&this.hass?F`
      ...
      >
        <div class="card-content">
          ${Vo("days_between_irrigation.description",this.hass.language)}
        </div>

        <div class="card-content">
          ${this._numRow(Vo("days_between_irrigation.label",this.hass.language),"",this.config.days_between_irrigation||0,(e=>this.handleConfigChange({days_between_irrigation:parseInt(e)})),1)}
          <div class="card-content">
            <div
              style="color: var(--secondary-text-color); font-size: 0.875rem; margin-top: 8px;"
            >
              ${Vo("days_between_irrigation.help_text",this.hass.language)}
            </div>
          </div>
        </div>
      </ha-card>
...
t.version="2.30.1",i(Gt),t.fn=or,t.min=Jt,t.max=Qt,t.now=Xt,t.utc=m,t.unix=lr,t.months=hr,t.isDate=u,t.locale=mt,t.invalid=f,t.duration=Si,t.isMoment=z,t.weekdays=fr,t.parseZone=dr,t.localeData=vt,t.isDuration=ri,t.monthsShort=vr,t.weekdaysMin=kr,t.defineLocale=gt,t.updateLocale=ht,t.locales=ft,t.weekdaysShort=br,t.normalizeUnits=ae,t.relativeTimeRounding=ts,t.relativeTimeThreshold=is,t.calendarFormat=Li,t.prototype=or,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t}()),yl.exports),wl=fl(zl);let xl=class extends(La(ce)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.opensprinklerStations={},this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t,i]=await Promise.all([Oa(this.hass),Pa(this.hass),Ca(this.hass),Ha(this.hass)]);this.config=e,this.zones=a,this.modules=t,this.mappings=i,await this._fetchOpenSprinklerStations(e),this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:vl.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,a){this.hass&&(this.zones[e]=a,a.id&&this.zoneCache.delete(a.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(a).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,a){if(!this.hass)return;const t=this.zones[a].id;if(!this.zones[a]||null==t)return;const i=[...this.zones];var n,r;this.zones=this.zones.filter(((e,t)=>t!==a)),this.zoneCache.delete(t.toString()),this.isSaving=!0,(n=this.hass,r=t.toString(),n.callApi("POST",je+"/zones",{id:r,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var a;const t=this.zones[e];if(!t||null==t.mapping)return;const i=`#weather-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var a;const t=this.zones[e];if(!t||null==t.id)return;const i=`#calendar-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const a=await Ia(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,a)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const t of this.zones)if(void 0!==t.id)try{const i=await(e=this.hass,a=t.id.toString(),e.callWS({type:je+"/watering_calendar",zone_id:a}));this.wateringCalendars.set(t.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${t.id}:`,e)}var e,a;this._scheduleUpdate()}}async _fetchOpenSprinklerStations(e){if(!this.hass||!e[Ae])return void(this.opensprinklerStations={});const[a,t]=await Promise.all([this.hass.callWS({type:"config/device_registry/list"}),this.hass.callWS({type:"config/entity_registry/list"})]),i=new Set(a.filter((e=>[e.name,e.name_by_user,e.manufacturer].filter(Boolean).some((e=>String(e).toLowerCase().includes("opensprinkler"))))).map((e=>e.id)));this.opensprinklerStations=Object.fromEntries(t.filter((e=>{var a,t,n,r;return i.has(e.device_id)&&(null===(a=e.entity_id)||void 0===a?void 0:a.startsWith("switch."))&&"station"===(null===(r=null===(n=null===(t=this.hass)||void 0===t?void 0:t.states[e.entity_id])||void 0===n?void 0:n.attributes)||void 0===r?void 0:r.opensprinkler_type)})).map((e=>{var a,t,i,n,r;return[e.entity_id,null!==(r=null!==(n=null===(i=null===(t=null===(a=this.hass)||void 0===a?void 0:a.states[e.entity_id])||void 0===t?void 0:t.attributes)||void 0===i?void 0:i.friendly_name)&&void 0!==n?n:e.name)&&void 0!==r?r:e.entity_id]})))}renderOpenSprinklerStationMapping(e){var a,t;if(!(null===(a=this.config)||void 0===a?void 0:a[Ae])||void 0===e.id)return q``;const i=null===(t=this.config[$e])||void 0===t?void 0:t[String(e.id)];return q`
            ...
            `:F`
              <div class="weather-table">
                <div class="weather-header">
                  <span
                    >${Vo("panels.mappings.weather-records.timestamp",this.hass.language)}</span
                  >
                  <span
                    >${Vo("panels.mappings.weather-records.temperature",this.hass.language)}</span
                  >
                  <span
                    >${Vo("panels.mappings.weather-records.humidity",this.hass.language)}</span
                  >
                  <span
                    >${Vo("panels.mappings.weather-records.precipitation",this.hass.language)}</span
                  >
                  <span
    ...
    `}renderWateringCalendar(e){if(!this.hass||"number"!=typeof e.id)return F``;const a=this.wateringCalendars.get(e.id),t=a&&e.id in a?a[e.id]:null,i=(null==t?void 0:t.monthly_estimates)||[];return F` <div class="watering-calendar">
      ...
      <ha-card class="zone-card">
        ...
        ${c?q` <div class="zone-body">
              <div class="zone-meta">
                <div class="meta-item">
                  <span class="meta-label"
                    >${Vo("panels.zones.labels.last_calculated",r)}</span
                  >
                ...
                <div class="meta-item">
                  <span class="meta-label"
                    >${Vo("panels.zones.labels.data-last-updated",r)}</span
                  >
                  <span class="meta-value"
                ...
                <div class="meta-item">
                  <span class="meta-label"
                    >${Vo("panels.zones.labels.data-number-of-data-points",r)}</span
                  >
                  <span class="meta-value"
              ...
              <div class="settings">
                ${this._textRow(Vo("panels.zones.labels.name",r),"",e.name,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[da]:t}))))}
                ${this._numRow(Vo("panels.zones.labels.size",r),Ta(this.config,ua),e.size,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ua]:parseFloat(t)}))),.1)}
                ${this._numRow(Vo("panels.zones.labels.throughput",r),Ta(this.config,ca),e.throughput,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ca]:parseFloat(t)}))),.1)}
                ${this._numRow(Vo("panels.zones.labels.drainage_rate",r),Ta(this.config,_a),e.drainage_rate,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[_a]:parseFloat(t)}))),.1)}
                ${this._selectRow(Vo("panels.zones.labels.state",r),q`
                    <option
                      value="${vl.Automatic}"
                      ?selected=${e.state===vl.Automatic}
                    >
                      ${Vo("panels.zones.labels.states.automatic",r)}
                    </option>
                    <option
                      value="${vl.Disabled}"
                      ?selected=${e.state===vl.Disabled}
                    >
                      ${Vo("panels.zones.labels.states.disabled",r)}
                    </option>
                    <option
                      value="${vl.Manual}"
                      ?selected=${e.state===vl.Manual}
                    >
                      ${Vo("panels.zones.labels.states.manual",r)}
                    </option>
                  `,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[pa]:t.target.value,[ma]:0}))))}
                ${this._selectRow(Vo("common.labels.module",r),this.renderTheOptions(this.modules,e.module),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[ga]:""===i?void 0:parseInt(i)}))}))}
                ${this._selectRow(Vo("panels.zones.labels.mapping",r),this.renderTheOptions(this.mappings,e.mapping),(t=>{const i=t.target.value;this.handleEditZone(a,Object.assign(Object.assign({},e),{[fa]:""===i?void 0:parseInt(i)}))}))}
                ${this.renderOpenSprinklerStationMapping(e)}
                ${this._numRow(Vo("panels.zones.labels.bucket",r),Ta(this.config,ha),Number(e.bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ha]:parseFloat(t)}))),.1)}
                ${this._numRow(Vo("panels.zones.labels.maximum-bucket",r),Ta(this.config,ha),Number(e.maximum_bucket).toFixed(1),(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ya]:parseFloat(t)}))),.1)}
                ${this._numRow(Vo("panels.zones.labels.et-deficiency",r),Ta(this.config,ha),null!=e.et_deficiency?Number(e.et_deficiency).toFixed(2):"",(()=>{}),.01,!0)}
                ${(null===(i=this.config)||void 0===i?void 0:i.observed_watering_enabled)?this._entityRow(Vo("panels.zones.labels.linked-entity",r),Vo("panels.zones.labels.optional",r),e.linked_entity,["switch","valve","input_boolean","binary_sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[za]:t||void 0}))),Vo("panels.zones.labels.linked-entity-hint",r)):""}
                ${(null===(n=this.config)||void 0===n?void 0:n.observed_watering_enabled)&&e.linked_entity?this._entityRow(Vo("panels.zones.labels.flow-sensor",r),Vo("panels.zones.labels.optional",r),e.flow_sensor,["sensor"],(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[wa]:t||void 0}))),Vo("panels.zones.labels.flow-sensor-hint",r)):""}
                ${this._numRow(Vo("panels.zones.labels.lead-time",r),"s",e.lead_time,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ba]:parseInt(t,10)}))),1)}
                ${this._numRow(Vo("panels.zones.labels.maximum-duration",r),"s",e.maximum_duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ka]:parseInt(t,10)}))),1)}
                ${this._numRow(Vo("panels.zones.labels.multiplier",r),"",e.multiplier,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[va]:parseFloat(t)}))),.1)}
                ${this._numRow(Vo("panels.zones.labels.duration",r),"s",e.duration,(t=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ma]:parseInt(t,10)}))),1,o)}
              </div>

              <div class="zone-actions">
                ${s?q`
                      ${this._actionBtn(qo,Vo("panels.zones.actions.calculate",r),(()=>this.handleCalculateZone(a)))}
                      ${this._actionBtn(Xo,Vo("panels.zones.actions.update",r),(()=>this.handleUpdateZone(a)))}
                    `:""}
                ${this._actionBtn(Jo,Vo("panels.zones.actions.reset-bucket",r),(()=>this.handleEditZone(a,Object.assign(Object.assign({},e),{[ha]:0}))))}
                ${null!=e.mapping?this._actionBtn(Go,Vo("panels.zones.actions.view-weather-info",r),(()=>this.handleViewWeatherInfo(a))):""}
                ${this._actionBtn("M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z",Vo("panels.zones.actions.view-watering-calendar",r),(()=>this.handleViewWateringCalendar(a)))}
                ${l?this._actionBtn("M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z",Vo("panels.zones.actions.information",r),(()=>this.toggleExplanation(a))):""}
                ${this._actionBtn(Yo,Vo("common.actions.delete",r),(e=>this.handleRemoveZone(e,a)),!0)}
              </div>

              ${l?q`<label class="hidden" id="calcresults${a}"
                    >${$a("<br/>"+e.explanation)}</label
                  >`:""}
    ...
    `}toggleExplanation(e){var a;const t=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("#calcresults"+e);t&&("hidden"!=t.className?t.className="hidden":t.className="explanation")}render(){return this.hass?this.isLoading?q`
        <ha-card header="${Vo("panels.zones.title",this.hass.language)}">
          <div class="card-content">
            ${Vo("common.loading-messages.general",this.hass.language)}...
          </div>
        </ha-card>
      ...
      <ha-card header="${Vo("panels.zones.title",this.hass.language)}">
        <div class="card-content">
          ${Vo("panels.zones.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Vo("panels.zones.cards.add-zone.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.zones.labels.name",this.hass.language)}
            </div>
            <input
              id="nameInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.zones.labels.size",this.hass.language)}
              <span class="unit">(${Ta(this.config,ua)})</span>
            </div>
            <input
              id="sizeInput"
              class="field"
          ...
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.zones.labels.throughput",this.hass.language)}
              <span class="unit"
                >(${Ta(this.config,ca)})</span
              >
            </div>
            <input
              id="throughputInput"
          ...
          <div class="add-zone-actions">
            ...
            >
              ...
              ${this.isSaving?Vo("common.saving-messages.adding",this.hass.language):Vo("panels.zones.cards.add-zone.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${Vo("panels.zones.cards.zone-actions.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="zone-actions-grid">
            ${this._actionBtn(qo,Vo("panels.zones.cards.zone-actions.actions.calculate-all",this.hass.language),(()=>this.handleCalculateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Xo,Vo("panels.zones.cards.zone-actions.actions.update-all",this.hass.language),(()=>this.handleUpdateAllZones()),!1,this.isSaving)}
            ${this._actionBtn(Jo,Vo("panels.zones.cards.zone-actions.actions.reset-all-buckets",this.hass.language),(()=>this.handleResetAllBuckets()),!1,this.isSaving)}
            ${this._actionBtn(Go,Vo("panels.zones.cards.zone-actions.actions.clear-all-weatherdata",this.hass.language),(()=>this.handleClearAllWeatherdata()),!1,this.isSaving)}
          </div>
        </div>
      </ha-card>
        ...
        ${s?F` <div class="si-body">
              <div class="moduleconfig">
                <label class="subheader"
                  ...
                  (*
                  ${Vo("panels.modules.cards.module.labels.required",this.hass.language)})</label
                >
                <div class="settings">
              ...
              ${n?q`<div class="weather-note">
                    ${Vo("panels.modules.cards.module.errors.cannot-delete-module-because-zones-use-it",this.hass.language)}
                  </div>`:q`<div class="si-actions">
                    ${this._actionBtn(Yo,Vo("common.actions.delete",this.hass.language),(e=>this.handleRemoveModule(e,a)),!0)}
                  </div>`}
            </div>`:""}
      </ha-card>
    ...
    `}handleEditConfig(e,a){this.modules=Object.values(this.modules).map(((t,i)=>i===e?a:t)),this.moduleCache.clear(),this._scheduleUpdate(),this.debouncedSave(a)}renderOption(e,a){return this.hass?q`<option value="${e}>${a}</option>`:q``}render(){return this.hass?q`
      <ha-card header="${Vo("panels.modules.title",this.hass.language)}">
        <div class="card-content">
          ${Vo("panels.modules.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Vo("panels.modules.cards.add-module.header",this.hass.language)}"
      >
        <div class="card-content">
          ${this.isLoading?q`<div class="loading-indicator">
                ...
                <div class="setting-row">
                  <div class="setting-label">
                    ${Vo("common.labels.module",this.hass.language)}
                  </div>
                  <div class="select-wrap">
                    <select
                      id="moduleInput"
      ...
      ${this.isLoading?q`<div class="loading-indicator">
            ${Vo("common.loading-messages.modules",this.hass.language)}
            ...
            ${i?q`<div class="weather-note">
                ...
                >
                  ...
                  <span class="action-button-label">
                    ${Vo("common.actions.delete",this.hass.language)}
                  </span>
                </div>`}
          </div>
        </div>
    ...
    `;return this.mappingCache.set(t,n),n}renderMappingSetting(e,a){const t=this.mappings[e];if(!t||!this.hass)return F``;const i=t.mappings[a];return F`
      <div class="si-subgroup">
        ...
        ${this._selectRow(Vo("panels.mappings.cards.mapping.source",this.hass.language),this.renderSimpleRadioOptions(e,a,i),(t=>this.handleSimpleSourceChange(e,a,t)))}
        ${this.renderMappingInputs(e,a,i)}
      </div>
    `}renderSimpleRadioOptions(e,a,t){if(!this.hass||!this.config)return q``;const i=a===Ie||a===Ve,n=t[aa],r=!!this.config.use_weather_service,s=i&&this.config.weather_service!==We;return q`
      ${r?q`<option
            value="${Ye}"
            ?selected=${n===Ye}
          >
    ...
    `}renderSensorInput(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${Vo("panels.mappings.cards.mapping.sensor-entity",this.hass.language)}
        </div>
        <ha-entity-picker
          class="entity-field"
          .hass=${this.hass}
    ...
    `:q``}renderStaticValueInput(e,a,t){return this.hass?this._numRow(Vo("panels.mappings.cards.mapping.static_value",this.hass.language),"",t[ia]||"",(t=>this.handleStaticValueChange(e,a,{target:{value:t}})),.1):q``}renderUnitSelect(e,a,t){return this.hass&&this.config?this._selectRow(Vo("panels.mappings.cards.mapping.input-units",this.hass.language),this.renderUnitOptionsForMapping(a,t),(t=>this.handleUnitChange(e,a,t))):q``}renderPressureTypeSelect(e,a,t){return this.hass?this._selectRow(Vo("panels.mappings.cards.mapping.pressure-type",this.hass.language),this.renderPressureTypes(a,t),(t=>this.handlePressureTypeChange(e,a,t))):q``}renderAggregateSelect(e,a,t){return this.hass?q`
      <div class="setting-row">
        <div class="setting-label">
          ${Vo("panels.mappings.cards.mapping.sensor-aggregate-use-the",this.hass.language)}
          <span class="unit"
            >${Vo("panels.mappings.cards.mapping.sensor-aggregate-of-sensor-values-to-calculate",this.hass.language)}</span
          >
        </div>
        <div class="select-wrap">
          <select
    ...
    `}renderAggregateOption(e,a){if(this.hass&&this.config){return q`<option value="${e}" ?selected="${e===a}">
        ${Vo("panels.mappings.cards.mapping.aggregates."+e,this.hass.language)}
      </option>`}return q``}renderPressureTypes(e,a){if(this.hass&&this.config){let e=q``;const t=a[Je];return e=q`${e}
        <option
          value="${Qe}"
          ?selected="${t===Qe}"
        >
          ${Vo("panels.mappings.cards.mapping.pressure_types."+Qe,this.hass.language)}
        </option>
        <option
          value="${Xe}"
          ?selected="${t===Xe}"
        >
          ${Vo("panels.mappings.cards.mapping.pressure_types."+Xe,this.hass.language)}
        </option>`,e}return q``}renderUnitOptionsForMapping(e,a){if(!this.hass||!this.config)return q``;const t=function(e){switch(e){case He:case qe:return[{unit:"°C",system:Ce},{unit:"°F",system:Pe}];case Be:case Ie:return[{unit:"mm",system:Ce},{unit:"in",system:Pe}];case Ue:return[{unit:oa,system:Ce},{unit:la,system:Pe}];case Le:return[{unit:"%",system:[Ce,Pe]}];case Re:return[{unit:"millibar",system:Ce},{unit:"hPa",system:Ce},{unit:"psi",system:Pe},{unit:"inch Hg",system:Pe}];case Fe:return[{unit:"km/h",system:Ce},{unit:"meter/s",system:Ce},{unit:"mile/h",system:Pe}];case Ve:return[{unit:"W/m2",system:Ce},{unit:"MJ/day/m2",system:Ce},{unit:"W/sq ft",system:Pe},{unit:"MJ/day/sq ft",system:Pe}];default:return[]}}(e);let i=a[na];const n=this.config.units;if(!a[na])for(const e of t)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const a of e.system)if(n===a.system){i=e.unit;break}if(i===e.unit)break}return q`
      ${t.map((e=>q`
    ...
    `}render(){return this.hass?this.isLoading?F`
      ...
      >
        <div class="card-content">
          ${Vo("panels.mappings.description",this.hass.language)}
        </div>
      </ha-card>

      <ha-card
        header="${Vo("panels.mappings.cards.add-mapping.header",this.hass.language)}"
      >
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.mappings.labels.mapping-name",this.hass.language)}
            </div>
          ...
          <div class="si-form-actions">
            ...
            >
              <ha-svg-icon slot="start" .path=${Qo}></ha-svg-icon>
              ${this.isSaving?Vo("common.saving-messages.adding",this.hass.language):Vo("panels.mappings.cards.add-mapping.actions.add",this.hass.language)}
            </ha-button>
          </div>
        </div>
      </ha-card>
    ...
    `:q``}renderMappingsList(){const e=this.mappings.slice(0,Math.min(this.mappings.length,10)),a=this.mappings.slice(10);return q`
      ...
      ${a.length>0?q`
          ...
          `:""}
    `}renderMappingCard(e,a){if(!this.hass)return q``;const t=this.hass.language,i=this.zones.filter((a=>a.mapping===e.id)).length,n=Object.keys(e.mappings||{}).length,r=[];r.push(`${n} ${Vo("panels.mappings.title",t).toLowerCase()}`),i&&r.push(`${i} ${Vo("panels.zones.title",t).toLowerCase()}`);const s=r.join(" · "),o=null!=e.id&&this._expanded.has(e.id);return q`
      <ha-card class="si-card">
        <div
          class="si-head"
          role="button"
        ...
        ${o?F`<div class="si-body">
              ...
              <div class="si-actions">
                ${i?q`<div class="weather-note">
                      ${Vo("panels.mappings.cards.mapping.errors.cannot-delete-mapping-because-zones-use-it",t)}
                    </div>`:this._actionBtn(Yo,Vo("common.actions.delete",t),(e=>this.handleRemoveMapping(e,a)),!0)}
              </div>
            </div>`:""}
      </ha-card>
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimers.forEach((e=>{clearTimeout(e)})),this.debounceTimers.clear(),this.globalDebounceTimer&&(clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=null),this.mappingCache.clear()}};r([he()],Sl.prototype,"config",void 0),r([he({type:Array})],Sl.prototype,"zones",void 0),r([he({type:Array})],Sl.prototype,"mappings",void 0),r([he({type:Map})],Sl.prototype,"weatherRecords",void 0),r([he({type:Boolean})],Sl.prototype,"isLoading",void 0),r([he({type:Boolean})],Sl.prototype,"isSaving",void 0),r([fe("#mappingNameInput")],Sl.prototype,"mappingNameInput",void 0),Sl=r([me("smart-irrigation-view-mappings")],Sl);let Al=class extends ce{constructor(){super(...arguments),this._use=!1,this._service=null,this._apiKey="",this._loading=!0,this._saving=!1,this._error="",this._saved=!1}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)})),this._load()}async _load(){var e;if(this.hass)try{const a=await(e=this.hass,e.callWS({type:je+"/weatherservice"}));this._info=a,this._use=!!a.use_weather_service,this._service=a.weather_service||(a.services&&a.services.includes(We)?We:a.services&&a.services.length?a.services[0]:null),this._apiKey=a.weather_service_api_key||"",this._error=""}catch(e){this._error=this._errText(e)}finally{this._loading=!1}}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}async _save(){if(this.hass){this._saving=!0,this._error="",this._saved=!1;try{await(e=this.hass,a={use_weather_service:this._use,weather_service:this._use?this._service:null,weather_service_api_key:this._use?this._apiKey:null},e.callWS(Object.assign({type:je+"/set_weatherservice"},a))),this._saved=!0,window.setTimeout((()=>this._load()),800)}catch(e){this._error=this._errText(e)}finally{this._saving=!1}var e,a}}render(){var e;if(!this.hass)return q``;const a=this.hass.language;return this._loading&&!this._info?q`
        <ha-card header="${Vo("panels.weatherservice.title",a)}">
          <div class="card-content">
            ${Vo("common.loading-messages.general",a)}...
          </div>
        </ha-card>
      `:q`
      <ha-card header="${Vo("panels.weatherservice.title",a)}">
        <div class="card-content ws-description">
          ${Vo("panels.weatherservice.description",a)}
        </div>
        <div class="card-content">
          <div class="setting-row">
            <div class="setting-label">
              ${Vo("panels.weatherservice.labels.use-weather-service",a)}
            </div>
            <ha-switch
              .checked=${this._use}
          ...
          ${this._use?F`
                ...
                ${this._service&&Ge.includes(this._service)?"":q`<div class="setting-row">
                      <div class="setting-label">
                        ${Vo("panels.weatherservice.labels.api-key",a)}
                      </div>
                      <input
                        class="field"
                        type="text"
                ...
                ${"Open Weather Map"===this._service?q`<div class="ws-note ws-note--hint">
                      ${Vo("panels.weatherservice.messages.owm-onecall-hint",a)}
                    </div>`:""}
              `:q`<div class="ws-note">
                ${Vo("panels.weatherservice.messages.no-service",a)}
              </div>`}
          ${this._error?q`<div class="ws-msg ws-msg--error">${this._error}</div>`:""}
          ${this._saved?q`<div class="ws-msg ws-msg--success">
                ${Vo("panels.weatherservice.messages.saved",a)}
              </div>`:""}
          ...
          <div class="ws-actions">
            <ha-button
              ...
              @click=${this._save}
            >
              ${this._saving?Vo("panels.weatherservice.actions.saving",a):Vo("panels.weatherservice.actions.save",a)}
            </ha-button>
          </div>
          <div class="ws-note ws-reload-note">
            ${Vo("panels.weatherservice.messages.reload-note",a)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
    ...
    `}};r([he()],Al.prototype,"narrow",void 0),r([he()],Al.prototype,"path",void 0),r([ve()],Al.prototype,"_info",void 0),r([ve()],Al.prototype,"_use",void 0),r([ve()],Al.prototype,"_service",void 0),r([ve()],Al.prototype,"_apiKey",void 0),r([ve()],Al.prototype,"_loading",void 0),r([ve()],Al.prototype,"_saving",void 0),r([ve()],Al.prototype,"_error",void 0),r([ve()],Al.prototype,"_saved",void 0),Al=r([me("smart-irrigation-view-weatherservice")],Al);let $l=class extends ce{constructor(){super(...arguments),this._busy=!1,this._error="",this._message="",this._pendingName=""}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}_errText(e){return e&&(e.message||e.code)?e.message||e.code:String(e)}_reset(){this._error="",this._message="",this._pending=void 0,this._pendingName=""}async _export(){if(this.hass){this._reset(),this._busy=!0;try{const a=await(e=this.hass,e.callApi("GET",je+"/export")),t=JSON.stringify(a,null,2),i=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(i),r=document.createElement("a");r.href=n;const s=(new Date).toISOString().slice(0,19).replace("T","_").replace(/:/g,"-");r.download=`smart_irrigation_backup_${s}.json`,r.click(),URL.revokeObjectURL(n),this._message=Vo("panels.backuprestore.messages.exported",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e}}async _onFile(e){this._reset();const a=e.target,t=a.files&&a.files[0];if(t)try{const e=await t.text(),a=JSON.parse(e);if(!a||"object"!=typeof a||!a.config)throw new Error(Vo("panels.backuprestore.messages.invalid-file",this.hass.language));this._pending=a,this._pendingName=t.name}catch(e){this._error=this._errText(e)}finally{a.value=""}}async _restore(){if(this.hass&&this._pending){this._busy=!0,this._error="",this._message="";try{const t=await(e=this.hass,a=this._pending,e.callApi("POST",je+"/restore",a));if(t&&!1===t.success)throw new Error(t.error||"restore failed");this._pending=void 0,this._pendingName="",this._message=Vo("panels.backuprestore.messages.restored",this.hass.language)}catch(e){this._error=this._errText(e)}finally{this._busy=!1}var e,a}}_count(e){const a=this._pending&&this._pending[e];return Array.isArray(a)?a.length:0}render(){if(!this.hass)return q``;const e=this.hass.language;return q`
        ...
        <div class="card-content">
          ...
          <div class="br-actions">
            ...
            >
              ...
              ${Vo("panels.backuprestore.actions.export",e)}
            </ha-button>
          </div>
        </div>
      </ha-card>
      ...
      <ha-card
        header="${Vo("panels.backuprestore.cards.restore.title",e)}"
      >
        <div class="card-content">
          <div class="br-description">
            ${Vo("panels.backuprestore.cards.restore.description",e)}
          </div>
                ...
                <div class="br-warning">
                  ...
                  <div>
                    <div class="br-warning-title">
                      ${Vo("panels.backuprestore.messages.confirm-title",e)}
                    </div>
                    <div class="br-file-name">${this._pendingName}</div>
                    <div class="br-summary">
                      ${Vo("panels.backuprestore.messages.summary",e)}:
                      ${this._count("zones")}
                      ${Vo("panels.zones.title",e)} ·
                      ${this._count("modules")}
                      ${Vo("panels.modules.title",e)} ·
                      ${this._count("mappings")}
                      ${Vo("panels.mappings.title",e)}
                    </div>
                    <div class="br-warning-text">
                      ${Vo("panels.backuprestore.messages.confirm-warning",e)}
                    </div>
                  </div>
                </div>
              `:""}
          ...
          ${this._pending?F`<div class="br-actions">
                ...
                >
                  ...
                  ${this._busy?Vo("panels.backuprestore.actions.restoring",e):Vo("panels.backuprestore.actions.restore",e)}
                </ha-button>
              </div>`:""}
          <div class="br-note">
            ${Vo("panels.backuprestore.messages.reload-note",e)}
          </div>
        </div>
      </ha-card>
    `}static get styles(){return p`
      ...
      `:F``}renderZoneBucketsCard(){if(!this.hass)return F``;if(!this.zones||0===this.zones.length)return F`
        ...
        >
          <div class="card-content">
            <div class="info-item">
              <span class="value"
                >${Vo("panels.info.cards.zone-bucket-values.no-zones",this.hass.language)}</span
              >
            </div>
          </div>
        </ha-card>
      `;const e=this.config?Ta(this.config,ha):"mm";return q`
      <ha-card
        header="${Vo("panels.info.cards.zone-bucket-values.title",this.hass.language)}"
      >
        <div class="card-content">
              ...
              <div class="zone-info">
                ...
                <div class="zone-details">
                  <div class="zone-bucket">
                    <span class="label"
                      >${Vo("panels.info.cards.zone-bucket-values.labels.bucket",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</span
                    >
                    <span class="value">
                  ...
                  <div class="zone-duration">
                    <span class="label"
                      >${Vo("panels.info.cards.zone-bucket-values.labels.duration",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}:</span
                    >
                    <span class="value">
                      ${a.duration?`${Math.round(a.duration)} ${Vo("common.units.seconds",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}`:`0 ${Vo("common.units.seconds",null!==(d=null===(l=this.hass)||void 0===l?void 0:l.language)&&void 0!==d?d:"en")}`}
                    </span>
                  </div>
                </div>
              </div>
    ...
    `}renderNextIrrigationCard(){var e,a,t,i,n,r,s,o;return this.hass&&this.info?F`
      ...
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${Vo("panels.info.cards.next-irrigation.labels.next-start",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.next_irrigation_start?wl(this.info.next_irrigation_start).format("YYYY-MM-DD HH:mm:ss"):Vo("panels.info.cards.next-irrigation.no-data",this.hass.language)}
            </span>
          </div>
          ...
          ${this.info.next_irrigation_duration?F`
                <div class="info-item">
                  ...
                  <span class="value"
                    ...
                    ${Vo("common.units.seconds",this.hass.language)}</span
                  >
                </div>
              `:""}
    ...
    `:F`
        ...
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${Vo("panels.info.cards.next-irrigation.labels.next-start",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${Vo("panels.info.cards.next-irrigation.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${Vo("panels.info.cards.next-irrigation.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      ...
      >
        <div class="card-content">
          <div class="info-item">
            <label
              >${Vo("panels.info.cards.irrigation-reason.labels.reason",this.hass.language)}:</label
            >
            <span class="value">
              ${this.info.irrigation_reason||Vo("panels.info.cards.irrigation-reason.no-data",this.hass.language)}
            </span>
          </div>
    ...
    `:F`
        ...
        >
          <div class="card-content">
            <div class="info-item">
              <label
                >${Vo("panels.info.cards.irrigation-reason.labels.reason",null!==(i=null===(t=this.hass)||void 0===t?void 0:t.language)&&void 0!==i?i:"en")}:</label
              >
              <span class="value">
                ${Vo("panels.info.cards.irrigation-reason.no-data",null!==(r=null===(n=this.hass)||void 0===n?void 0:n.language)&&void 0!==r?r:"en")}
              </span>
            </div>
            <div class="info-note">
              ${Vo("panels.info.cards.irrigation-reason.backend-todo",null!==(o=null===(s=this.hass)||void 0===s?void 0:s.language)&&void 0!==o?o:"en")}
            </div>
          </div>
        </ha-card>
      `}static get styles(){return p`
      ...
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            ...
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${Vo("title",this.hass.language)}</div>
              ...
              <ha-tab-group @wa-tab-show=${this.handlePageSelected}>
                ${Object.values(Ol).map((a=>q`
                    <ha-tab-group-tab
                      ...
                      .active=${e.page===a}
                    >
                      ${Vo(`panels.${a}.title`,this.hass.language)}
                    </ha-tab-group-tab>
                  `))}
              </ha-tab-group>
            `:F`
    ...
    `}getView(e){switch(e.page){case"info":return F`
        ...
        `;case"help":return q`<ha-card
          header="${Vo("panels.help.cards.how-to-get-help.title",this.hass.language)}"
        >
          <div class="card-content">
            ${Vo("panels.help.cards.how-to-get-help.first-read-the",this.hass.language)}
            <a href="https://altmenorg.github.io/HAsmartirrigation/"
              >${Vo("panels.help.cards.how-to-get-help.wiki",this.hass.language)}</a
            >.
            ${Vo("panels.help.cards.how-to-get-help.if-you-still-need-help",this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/smart-irrigation-save-water-by-precisely-watering-your-lawn-garden"
              >${Vo("panels.help.cards.how-to-get-help.community-forum",this.hass.language)}</a
            >
            ${Vo("panels.help.cards.how-to-get-help.or-open-a",this.hass.language)}
            <a href="https://github.com/altmenorg/HAsmartirrigation/issues"
              >${Vo("panels.help.cards.how-to-get-help.github-issue",this.hass.language)}</a
            >
        ...
        `}}navigateToPage(e){if(e!==Ml().page){const a=Dl(e);Da(0,a),this.requestUpdate()}else scrollTo(0,0)}handlePageSelected(e){const a=e.detail.name;if(a!==Ml().page){const e=Dl(a);Da(0,e),this.requestUpdate()}else scrollTo(0,0)}static get styles(){return[Tl,p`
        :host {
          color: var(--primary-text-color);
