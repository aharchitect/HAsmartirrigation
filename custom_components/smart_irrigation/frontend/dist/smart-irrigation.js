...
t.version="2.30.1",i(Gt),t.fn=or,t.min=Jt,t.max=Qt,t.now=Xt,t.utc=m,t.unix=lr,t.months=hr,t.isDate=u,t.locale=mt,t.invalid=f,t.duration=Si,t.isMoment=z,t.weekdays=fr,t.parseZone=dr,t.localeData=vt,t.isDuration=ri,t.monthsShort=vr,t.weekdaysMin=kr,t.defineLocale=gt,t.updateLocale=ht,t.locales=ft,t.weekdaysShort=br,t.normalizeUnits=ae,t.relativeTimeRounding=ts,t.relativeTimeThreshold=is,t.calendarFormat=Li,t.prototype=or,t.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"GGGG-[W]WW",MONTH:"YYYY-MM"},t}()),zl.exports),jl=kl(xl);let Sl=class extends(Ua(ce)){constructor(){super(...arguments),this.zones=[],this.modules=[],this.mappings=[],this.wateringCalendars=new Map,this.weatherRecords=new Map,this.opensprinklerStations={},this.isLoading=!0,this.isSaving=!1,this.isCreatingZone=!1,this._hasLoadedOnce=!1,this._suppressNextConfigUpdate=!1,this._updateScheduled=!1,this.globalDebounceTimer=null,this.zoneCache=new Map,this._expanded=new Set}_scheduleUpdate(){this._updateScheduled||(this._updateScheduled=!0,requestAnimationFrame((()=>{this._updateScheduled=!1,this.requestUpdate()})))}_toggleZone(e){null!=e&&(this._expanded.has(e)?this._expanded.delete(e):this._expanded.add(e),this._scheduleUpdate())}firstUpdated(){_e().catch((e=>{console.error("Failed to load HA form:",e)}))}hassSubscribe(){return this._fetchData().catch((e=>{console.error("Failed to fetch initial data:",e)})),[this.hass.connection.subscribeMessage((()=>{this.isCreatingZone?console.debug("Skipping data refresh during zone creation"):this._suppressNextConfigUpdate?this._suppressNextConfigUpdate=!1:this._fetchData().catch((e=>{console.error("Failed to fetch data on config update:",e)}))}),{type:je+"_config_updated"})]}async _fetchData(){if(this.hass)try{this._hasLoadedOnce||(this.isLoading=!0);const[e,a,t,i]=await Promise.all([Pa(this.hass),Ha(this.hass),Ia(this.hass),La(this.hass)]);this.config=e,this.zones=a,this.modules=t,this.mappings=i,await this._fetchOpenSprinklerStations(e),this._fetchWateringCalendars(),this._fetchWeatherRecords(),this.zoneCache.clear()}catch(e){console.error("Error fetching data:",e)}finally{this.isLoading=!1,this._hasLoadedOnce=!0,this._scheduleUpdate()}}handleCalculateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{calculate_all:!0})).catch((e=>{console.error("Failed to calculate all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleUpdateAllZones(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{update_all:!0})).catch((e=>{console.error("Failed to update all zones:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleResetAllBuckets(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{reset_all_buckets:!0})).catch((e=>{console.error("Failed to reset all buckets:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleClearAllWeatherdata(){var e;this.hass&&(this.isSaving=!0,(e=this.hass,e.callApi("POST",je+"/zones",{clear_all_weatherdata:!0})).catch((e=>{console.error("Failed to clear all weather data:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})))}handleAddZone(){if(!this.nameInput.value.trim())return;this.isCreatingZone=!1;const e={name:this.nameInput.value.trim(),size:parseFloat(this.sizeInput.value)||0,throughput:parseFloat(this.throughputInput.value)||0,state:bl.Automatic,duration:0,bucket:0,module:void 0,delta:0,et_deficiency:0,explanation:"",multiplier:1,mapping:void 0,lead_time:0,maximum_duration:void 0,maximum_bucket:void 0,drainage_rate:void 0,current_drainage:0};this.zones=[...this.zones,e],this.isSaving=!0,this.saveToHA(e).then((()=>(this.nameInput.value="",this.sizeInput.value="",this.throughputInput.value="",this._fetchData()))).catch((e=>{console.error("Failed to add zone:",e),this.zones=this.zones.slice(0,-1)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleEditZone(e,a){this.hass&&(this.zones[e]=a,a.id&&this.zoneCache.delete(a.id.toString()),this.globalDebounceTimer&&clearTimeout(this.globalDebounceTimer),this.globalDebounceTimer=window.setTimeout((()=>{this.isSaving=!0,this._suppressNextConfigUpdate=!0,this.saveToHA(a).catch((e=>{this._suppressNextConfigUpdate=!1,console.error("Failed to save zone:",e)})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()})),this.globalDebounceTimer=null}),500),this._scheduleUpdate())}handleRemoveZone(e,a){if(!this.hass)return;const t=this.zones[a].id;if(!this.zones[a]||null==t)return;const i=[...this.zones];var n,r;this.zones=this.zones.filter(((e,t)=>t!==a)),this.zoneCache.delete(t.toString()),this.isSaving=!0,(n=this.hass,r=t.toString(),n.callApi("POST",je+"/zones",{id:r,remove:!0})).catch((e=>{console.error("Failed to delete zone:",e),this.zones=i,this._fetchData().catch((e=>{console.error("Failed to refresh data after delete error:",e)}))})).finally((()=>{this.isSaving=!1,this._scheduleUpdate()}))}handleCalculateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,calculate:!0,override_cache:!0})))}handleUpdateZone(e){const a=this.zones[e];var t,i;a&&null!=a.id&&(this.hass&&(t=this.hass,i=a.id.toString(),t.callApi("POST",je+"/zones",{id:i,update:!0})))}handleViewWeatherInfo(e){var a;const t=this.zones[e];if(!t||null==t.mapping)return;const i=`#weather-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}handleViewWateringCalendar(e){var a;const t=this.zones[e];if(!t||null==t.id)return;const i=`#calendar-section-${t.id}`,n=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector(i);n&&(n.hasAttribute("hidden")?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}async _fetchWeatherRecords(){if(this.hass){for(const e of this.zones)if(void 0!==e.id&&void 0!==e.mapping)try{const a=await Ba(this.hass,e.mapping.toString(),10);this.weatherRecords.set(e.id,a)}catch(a){console.error(`Failed to fetch weather records for zone ${e.id} (mapping ${e.mapping}):`,a)}this._scheduleUpdate()}}async _fetchWateringCalendars(){if(this.hass){for(const t of this.zones)if(void 0!==t.id)try{const i=await(e=this.hass,a=t.id.toString(),e.callWS({type:je+"/watering_calendar",zone_id:a}));this.wateringCalendars.set(t.id,i)}catch(e){console.error(`Failed to fetch watering calendar for zone ${t.id}:`,e)}var e,a;this._scheduleUpdate()}}async _fetchOpenSprinklerStations(e){if(!this.hass||!e[Ae])return void(this.opensprinklerStations={});const[a,t]=await Promise.all([this.hass.callWS({type:"config/device_registry/list"}),this.hass.callWS({type:"config/entity_registry/list"})]),i=new Set(a.filter((e=>[e.name,e.name_by_user,e.manufacturer].filter(Boolean).some((e=>String(e).toLowerCase().includes("opensprinkler"))))).map((e=>e.id)));this.opensprinklerStations=Object.fromEntries(t.filter((e=>{var a,t,n,r;return i.has(e.device_id)&&(null===(a=e.entity_id)||void 0===a?void 0:a.startsWith("switch."))&&"station"===(null===(r=null===(n=null===(t=this.hass)||void 0===t?void 0:t.states[e.entity_id])||void 0===n?void 0:n.attributes)||void 0===r?void 0:r.opensprinkler_type)})).map((e=>{var a,t,i,n,r;return[e.entity_id,null!==(r=null!==(n=null===(i=null===(t=null===(a=this.hass)||void 0===a?void 0:a.states[e.entity_id])||void 0===t?void 0:t.attributes)||void 0===i?void 0:i.friendly_name)&&void 0!==n?n:e.name)&&void 0!==r?r:e.entity_id]})))}renderOpenSprinklerStationMapping(e){var a,t;if(!(null===(a=this.config)||void 0===a?void 0:a[Ae])||void 0===e.id)return q``;const i=null===(t=this.config[$e])||void 0===t?void 0:t[String(e.id)];return q`
      ...
      </div>`}async handleOpenSprinklerStationChange(e,a){var t,i;if(!this.hass||void 0===e.id)return;const n=Object.assign({},null!==(i=null===(t=this.config)||void 0===t?void 0:t[$e])&&void 0!==i?i:{});a?n[String(e.id)]=a:delete n[String(e.id)];const r=this.config;this.config=Object.assign(Object.assign({},this.config),{[$e]:n}),this._suppressNextConfigUpdate=!0,this._scheduleUpdate();try{await Ca(this.hass,{[$e]:n})}catch(e){this.config=r,this._suppressNextConfigUpdate=!1,console.error("Failed to save OpenSprinkler station mapping:",e),this._scheduleUpdate()}}renderWeatherRecords(e){if(!this.hass||"number"!=typeof e.id)return q``;const a=this.weatherRecords.get(e.id)||[];return q`
    ...
    `}renderSimpleRadioOptions(e,a,t){if(!this.hass||!this.config)return q``;const i=a===Le||a===qe,n=t[ta],r=a===Ue,s=!!this.config.use_weather_service&&!r,o=i||r,l=i&&this.config.weather_service!==Ge;return q`
      ${s?q`<option
            value="${Ze}"
            ?selected=${n===Ze}
          >
    ...
    `}renderAggregateOption(e,a){if(this.hass&&this.config){return q`<option value="${e}" ?selected="${e===a}">
        ...
        </option>`,e}return q``}renderUnitOptionsForMapping(e,a){if(!this.hass||!this.config)return q``;const t=function(e){switch(e){case Ie:case Fe:return[{unit:"°C",system:He},{unit:"°F",system:Ce}];case Ue:case Le:return[{unit:"mm",system:He},{unit:"in",system:Ce}];case Re:return[{unit:la,system:He},{unit:da,system:Ce}];case Be:return[{unit:"%",system:[He,Ce]}];case Ve:return[{unit:"millibar",system:He},{unit:"hPa",system:He},{unit:"psi",system:Ce},{unit:"inch Hg",system:Ce}];case We:return[{unit:"km/h",system:He},{unit:"meter/s",system:He},{unit:"mile/h",system:Ce},{unit:"knot",system:[He,Ce]}];case qe:return[{unit:"W/m2",system:He},{unit:"MJ/day/m2",system:He},{unit:"W/sq ft",system:Ce},{unit:"MJ/day/sq ft",system:Ce}];default:return[]}}(e);let i=a[ra];const n=this.config.units;if(!a[ra])for(const e of t)if("string"==typeof e.system){if(n===e.system){i=e.unit;break}}else{for(const a of e.system)if(n===a.system){i=e.unit;break}if(i===e.unit)break}return q`
      ${t.map((e=>q`
