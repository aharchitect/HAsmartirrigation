...
- [x] **Step 1: Define the E2E dependency boundary**
...
- [x] **Step 2: Add explicit Make targets**
...
- [x] **Step 3: Ignore generated E2E artifacts**
...
- [x] **Step 4: Verify configuration-only changes**
...
- [x] **Step 1: Add the minimal HA configuration fixtures**
...
- [x] **Step 2: Implement temporary config creation**
...
- [x] **Step 3: Implement deterministic auth/config state**
...
- [x] **Step 4: Start and stop the Testcontainers instance**
...
- [x] **Step 5: Add readiness and failure diagnostics**
...
- [x] **Step 6: Verify fixture startup in isolation**
...
- [x] **Step 1: Write client contract tests with a local fake server**
...
- [x] **Step 2: Implement the HTTP client**
...
- [x] **Step 3: Implement the WebSocket command helper**
...
- [x] **Step 1: Add startup/load assertion**
...
- [x] **Step 2: Add panel asset assertion**
...
- [x] **Step 3: Add service registration/call assertion**
...
- [x] **Step 4: Add WebSocket baseline assertions**
...
- [x] **Step 5: Add config-entry/entity assertion**
...
- [x] **Step 6: Add controlled restart persistence assertion**
...
- [x] **Step 7: Verify the runtime suite**
...
- [x] **Step 1: Run diagnostics on changed Python files**
...
- [x] **Step 2: Run the existing test and quality suites**
...
- [x] **Step 3: Run hassfest and package checks**
...
- [x] **Step 4: Exercise cleanup and failure retention**
